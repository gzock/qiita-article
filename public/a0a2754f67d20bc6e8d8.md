...
tags:
  ...
  - IPoE
private: false
updated_at: '2026-01-12T22:52:02+09:00'
...
ちなみに、公式サービスの [NetMeister](https://www.necplatforms.co.jp/product/netmeister/) を使うとめちゃくちゃ簡単にDDNSをやれるので、こっちのほうが良いかもしれない。

自分的には、以前から使っているDDNSをそのまま利用したかったので、こちらのコンフィグで実現している。
以前は ieserver, 今は乗り換えて [Duck DNS](https://www.duckdns.org/) を使っているのだが、どちらもこちらのコンフィグの使い方で問題なく運用できている。
